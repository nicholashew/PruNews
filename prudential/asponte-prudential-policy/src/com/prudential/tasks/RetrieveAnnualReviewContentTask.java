...
import com.prudential.vp.RetrieveAnnualReviewAction;
...
public class RetrieveAnnualReviewContentTask extends TimerTask {

   /** Logger for the class */
   private static Logger s_log = Logger.getLogger(RetrieveAnnualReviewContentTask.class.getName());
   ...
   public void run() {
      ...
      if (isDebug) {
         s_log.entering("RetrieveAnnualReviewContentTask", "run");
      }
      ...
      try {
         ...
         RetrieveAnnualReviewAction vpA = new RetrieveAnnualReviewAction();
      ...
      if (isDebug) {
         s_log.exiting("RetrieveAnnualReviewContentTask", "run");
      }
