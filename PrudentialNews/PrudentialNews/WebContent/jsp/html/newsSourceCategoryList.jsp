...
function filterCategories(filterText) {
	...
	$(".newsSourcecategory-list li").each(function(){
...
$(function(){
	$(".newsSourcecategory-filter .clear-icon").click(function(){
		$(".newsSourcecategory-filter input").val("");
		filterCategories("");
	});
	$(".newsSourcecategory-filter .search-icon").click(function(){
		filterCategories($(".newsSourcecategory-filter input").val());
	});
	
	for(var i = 0; i < selectedCategories.length; ++i) {
		$("ul.newsSourcecategory-list > li > input#"+selectedCategories[i]).prop("checked", true);
	}
...
ul.newsSourcecategory-list > li > label {
	margin-left:10px;
}
ul.newsSourcecategory-list > li > input[type='checkbox'] {
    float:right;
	margin-right:10px;
}
.newsSourcecategory-filter {
	position: relative;
}
.newsSourcecategory-filter > input {
	width:300px;
	height:30px;
	-webkit-border-radius: 5px;
	-moz-border-radius: 5px;
...
.newsSourcecategory-filter > .clear-icon {
...
.newsSourcecategory-filter > .search-icon {
	display:inline-block;
...
<div class="newsSourcecategory-filter">
