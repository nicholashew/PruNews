...
public class CreateOrRetrieveSiteAreaScopedAction implements VirtualPortalScopedAction {

   private static Logger s_log = Logger.getLogger(CreateOrRetrieveSiteAreaScopedAction.class.getName());
   ...
   public void setParentname(String p_parentuuid) {
      parentname = p_parentuuid;
   }
    ...
    */
   public CreateOrRetrieveSiteAreaScopedAction(String p_parentName, String p_siteareaname, String p_libraryname) {
   ...
   public void run() throws WCMException {
      ...
      boolean isDebug = s_log.isLoggable(Level.FINEST);
      if (isDebug) {
         s_log.entering("CreateOrRetrieveSiteAreaScopedAction", "run parentname="+parentname +", siteareaname="+siteareaname+", libraryname="+libraryname);
      }
      ...
      if (ws != null) {
         try {
            ...
            theSiteAreaId = Utils.getSiteAreaIdByName(ws, parentname, libraryname);
      ...
      if (isDebug) {
         s_log.exiting("CreateOrRetrieveSiteAreaScopedAction", "run value is "+this.getReturnedValue());
      }
